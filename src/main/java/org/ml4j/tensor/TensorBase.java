...
public abstract class TensorBase<V extends TensorBase<V, D>, D extends TensorOperations<D>> extends AutogradValueImpl<V, D, Size> implements AutogradValue<V, D, Size>, DifferentiableWrappedTensorOperations<V, D>, TensorOperations<V>, org.ml4j.autograd.DataSupplier<D>, Tensor<V, D> {
